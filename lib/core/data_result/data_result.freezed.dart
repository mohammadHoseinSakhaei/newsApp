...
abstract class Success<T> extends DataResult<T> {
...
class _$FailureImpl<T> extends Failure<T> {
  ...
  @override
  String toString() {
    return 'DataResult<$T>.failure(failure: $failure)';
  }
...
abstract class Failure<T> extends DataResult<T> {
  const factory Failure(final AppException failure) = _$FailureImpl<T>;
